...
export default function Publications() {
  return (
    <section id="research" className="px-5 md:px-12 py-[60px] md:py-[100px] max-w-[1200px] mx-auto relative">
      <SectionHeader
        label="// Research"
        title="Publications"
      ...
      >
        {publications.map((pub, i) => (
          ...
          >
            ...
            {/* Mobile: badges row | Desktop: venue badge vertical */}
            <div className="flex flex-row sm:flex-col items-start gap-2 sm:gap-0">
              {/* Venue badge — horizontal pill on mobile, vertical on desktop */}
              <div
                className="font-mono text-[11px] font-bold uppercase tracking-[1px] rounded-[6px] border sm:[writing-mode:vertical-lr] sm:rotate-180"
                style={{
                  padding: '8px 10px',
              ...
              {/* Type badge — inline on mobile, hidden here on desktop (shown separately) */}
              <span
                className="sm:hidden text-[10px] font-semibold px-[10px] py-1 rounded-full border whitespace-nowrap"
                style={{
                  background: 'rgba(0,212,255,0.08)',
                  color: 'var(--cyan)',
                  borderColor: 'rgba(0,212,255,0.15)',
            ...
            <span
              className="hidden sm:inline-block text-[10px] font-semibold px-[10px] py-1 rounded-full border whitespace-nowrap"
              style={{
                background: 'rgba(0,212,255,0.08)',
                color: 'var(--cyan)',
                borderColor: 'rgba(0,212,255,0.15)',
